...
// Paper crush sound
let paperCrushSFX = new Audio("assets/sounds/paperCrushing.mp3");
// Throwing paper away sound
let throwingAwaySFX = new Audio("assets/sounds/throwPaperAway.mp3");
let timer;
...
function assignPapersProperties() {
  ...
  for (let i = 0; i < numPapers; i++) {
    ...
    let imageUrl = "assets/images/paper.png";
    $allPapers[i].css({
